...
module Demo {
    ...
    function sample(i as Number) as Dictionary {
        var n = i % count();
        switch (n) {
            case 0: return { "m" => Maneuver.RIGHT,        "d" => "200 m",
                             "s" => "Rue de Lausanne",     "e" => "12:34" };
            case 1: return { "m" => Maneuver.SLIGHT_LEFT,  "d" => "50 m",
                             "s" => "Avenue de la Gare",   "e" => "12:36" };
            case 2: return { "m" => Maneuver.ROUNDABOUT,   "d" => "400 m",
                             "s" => "Route de Berne exit 3", "e" => "12:41" };
            case 3: return { "m" => Maneuver.UTURN,        "d" => "80 m",
                             "s" => "Chemin des Fleurettes", "e" => "12:45" };
            case 4: return { "m" => Maneuver.STRAIGHT,     "d" => "1.2 km",
                             "s" => "Boulevard de Perolles very long name here",
                             "e" => "12:52" };
        }
        return { "m" => Maneuver.ARRIVE, "d" => "", "s" => "Destination", "e" => "12:58" };
    }
}
